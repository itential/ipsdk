...
"""HTTP enumerations for status codes and methods.

This module provides comprehensive enumerations for HTTP status codes and methods
...
class HTTPStatus(Enum):
    ...
    Includes all standard HTTP status codes defined in RFC specifications,
